...
export default function ServiceRequestsPage() {
  ...
  const statusBadge = (status: string) => {
    const map: Record<string, string> = {
      pending: "bg-gradient-to-r from-amber-400 to-amber-600 text-white",
      approved: "bg-gradient-to-r from-dark-gold to-dark-gold/90 text-white",
      rejected: "bg-gradient-to-r from-dark-rose to-dark-rose/90 text-white",
    };
