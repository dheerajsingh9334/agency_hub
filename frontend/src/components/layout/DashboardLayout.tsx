...
const navByRole = {
  admin: [
    ...
    { to: "/admin/signup", icon: ShieldCheck, label: "Create Admin" },
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      >
        <div className="flex h-16 items-center gap-2 border-b border-sidebar-border px-4 bg-gradient-to-r from-dark-gold/20 to-dark-rose/20">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-dark-gold to-dark-rose shadow-lg">
            <Building2 className="h-4 w-4 text-white" />
          </div>
          <span className="text-sm font-bold tracking-tight bg-gradient-to-r from-dark-gold to-dark-rose bg-clip-text text-transparent">
            Dheeraj Software
          </span>
          <Button
            variant="ghost"
        ...
        <div className="border-t border-sidebar-border p-3">
          <div className="mb-2 flex items-center gap-2 px-3">
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-dark-gold to-dark-rose text-xs font-bold text-white shadow-lg">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 items-center gap-4 border-b bg-gradient-to-r from-dark-gold/5 to-dark-rose/5 backdrop-blur-sm px-4 md:px-6 sticky top-0 z-20">
          <Button
            variant="ghost"
            size="icon"
            className="md:hidden hover:bg-dark-gold/10"
            onClick={() => setSidebarOpen(true)}
          >
            <Menu className="h-5 w-5" />
          </Button>
          <h1 className="text-lg font-semibold tracking-tight bg-gradient-to-r from-dark-gold to-dark-rose bg-clip-text text-transparent">
